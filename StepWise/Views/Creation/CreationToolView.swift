...
struct TutorialCreationToolView_Previews: PreviewProvider {
    static var previews: some View {
        List {
            CreationToolView(tool: Tool(id: UUID(), title: "Hammer", amount: 1, link: "https://example.com/tool/hammer", price: 5.0), tutorial_id: "123e4567-e89b-12d3-a456-426614174002")
                .environmentObject(GlobalUIState())
            CreationToolView(tool: Tool(id: UUID(), title: "Screwdriver", amount: 2, link: "https://example.com/tool/screwdriver", price: 5.0), tutorial_id: "123e4567-e89b-12d3-a456-426614174002")
                .environmentObject(GlobalUIState())
        }
    }
}
